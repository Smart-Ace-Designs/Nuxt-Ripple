...
```sh
bunx giget gh:smart-ace-designs/nuxt-ripple project-name
```
...
After deploying the Nuxt **ripple** template you will see the following files and directories in your project root:
